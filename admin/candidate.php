                                    ...
                                    <tr>
                                        ...
                                        if ($query->num_rows > 0) {
                                            while ($row = $query->fetch_array()) {
                                                ...
                                                <td width="50"><img src="<?php echo $row['img']; ?>" width="50" height="50"
                                                ...
                                                <td style="text-align:center">
                                                    ...
                                                    <a rel="tooltip" title="Edit" id="<?php echo $row['candidate_id'] ?>"
                                                        href="#edit_candidate<?php echo $row['candidate_id'] ?>"
                                                        data-toggle="modal" class="btn btn-success btn-outline"><i
