        ...
        <div class="modal-content">
				...
				<form method = "post" enctype = "multipart/form-data">
					<div class="form-group">
						...
						<select class = "form-control" name = "position">
								<option selected>-- Select Position of Candidate --</option>
					...
					<div class="form-group">
						<label>Party</label>
							<input class="form-control" type ="text" name = "party" placeholder="-- Please Enter Name of Party --" required="true">
					</div>
			...
			<?php
				...
				if (isset ($_POST ['save'])){
					...
					$conn->query("INSERT INTO candidate(position,firstname,lastname,year_level,gender,party,img)values('$position','$firstname','$lastname','$year_level','$gender','$party','$location')")or die(mysql_error());
				}
			?>
        </div>
