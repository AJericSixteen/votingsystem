...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2020 at 03:48 AM
...
(1, 'admin', 'cuteako03', 'admin', 'admin'),
(6, 'admin', '1234', 'Karburador', 'Ubuntu');
...
(1246, 1123, 'ATlQzJgB', 'test', 'test', 'Grade 11', 'Unvoted', '');
...
--
ALTER TABLE `voters`
  MODIFY `voters_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1247;
